...
const Welcome = () => {
  ...
  const commonStyles =
    "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-4 text-white ";


  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-14 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10 ">
          ...
          <p className="text-left text-white mt-5 md:w-9/12 w-11/12 font-light text-base">
            Explore the Crypto World. Buy and sell crypto all across the world.
          </p>
        ...
        >
          <div className="flex justify-between flex-col w-full h-full">
            ...
            <div>
              ...
              <p className="text-white text-semibold text-lg mt-1">Ethereum</p>
            </div>
          </div>
        </div>

        <div className="p-5 sm:w-96 w-full flex flex-col flex-start justify-center items-center blue-glassmorphism">
        <Input placeholder="Address To" name="addressTo" type="text" handleChange={handleChange} />
            ...
            <Input placeholder="Enter Message" name="message" type="text" handleChange={handleChange} />
              ...
              {isLoading ? (
                ...
                className="text-white border-[1px] w-full mt-2 p-2 border-[#3d4f7c] rounded-full cursor-pointer"
                >
                Send now</button>)
              }
        </div>
